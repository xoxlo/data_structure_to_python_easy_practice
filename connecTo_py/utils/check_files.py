...
def get_file_list():
    file_list = [file for file in os.listdir("/Users/songchangseok/Desktop/자료구조 및 알고리즘/data_structure_to_python_easy_practice/Chapter_1") if "1." in file]
...
def make_info(file_list, total_file_cnt):
    ...
    for file in file_list:
        temp = f"- [{file}](https://github.com/xoxlo/data_structure_to_python_easy_practice/tree/main/{file})\n"
        info += temp
    return info
