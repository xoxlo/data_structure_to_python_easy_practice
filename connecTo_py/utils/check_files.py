...
def get_file_list():
    file_list = [file for file in os.listdir("/Users/songchangseok/Desktop/자료구조 및 알고리즘/data_structure_to_python_easy_practice") if "1." in file]
