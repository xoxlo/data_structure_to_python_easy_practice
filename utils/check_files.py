...
def update_readme():
    ...
    info = make_info_prac(file_list_prac) + make_info(file_list) + make_info2(file_list2) + make_info3(file_list3) + make_info4(file_list4) + make_info5(file_list5) + make_info6(file_list6) + make_info7(file_list7) + make_info8(file_list8) + make_info9(file_list9) + make_info10(file_list10)
